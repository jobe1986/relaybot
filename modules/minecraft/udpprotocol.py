		...
		self.msgre = {
			'Server thread': {
				...
				'DEATH': [
					...
					re.compile('^(?P<message>(?P<name>[^ ]*?) was killed whilst fighting .*?)$'),
					...
					re.compile('^(?P<message>(?P<name>[^ ]*?) was burnt to a crisp whilst fighting .*? wielding .*?)$'),
					...
					re.compile('^(?P<message>(?P<name>[^ ]*?) left the confines of this world whilst fighting .*?)$'),
					re.compile('^(?P<message>(?P<name>[^ ]*?) was obliterated by a sonically-charged shriek)$'),
					re.compile('^(?P<message>(?P<name>[^ ]*?) was obliterated by a sonically-charged shriek whilst trying to escape .*? wielding .*?)$'),
					re.compile('^(?P<message>(?P<name>[^ ]*?) was obliterated by a sonically-charged shriek whilst trying to escape .*?)$'),
